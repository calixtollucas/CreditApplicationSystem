...
class CreditRepositoryTest {
    ...
    @Autowired lateinit var testEntityManager: TestEntityManager //classe que simula os testes no BD

    private lateinit var customer: Customer
    private lateinit var credit1: Credit
    private lateinit var credit2: Credit

    @BeforeEach // cada vez que rodarmos um teste iremos salvar esses atributos no BD
    fun setup(){
        customer = testEntityManager.persist(buildCustomer());
        credit1 = testEntityManager.persist(buildCredit(customer = customer))
        credit2 = testEntityManager.persist(buildCredit(customer = customer))
        //salvando o customer e os créditos no BD
    }
    ...
    private fun buildCredit(
        ...
        dateFirstInstallmant = dayFirstInstallment,
